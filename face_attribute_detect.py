...
class deep_face_detect():
    def __init__(self):
        self.img_gape_PATH = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/gape_picture_"
        self.img_face_PATH = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/gape_picture_"
        self.show_path_origin = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/origin_frame.png"
        self.show_path_rotate = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/origin_frame_rotate.png"
        self.pTime = 0 
        self.models = {}
        self.models["age"] = DeepFace.build_model("Age")
        self.models["gender"] = DeepFace.build_model("Gender")
        self.location_data_PATH = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/box_data_"
    ...
    def detect_age_and_gender(self, id):
        ...
        #cv2.imwrite("C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/test.png",img_content)
        ...
        cv2.imwrite("C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/detect_target.png", target)
    ...
    def vote_data(self,vote_id, age,gender,log_gender,center_x,center_y,flag_model):
        ...
        if center_distance<int(1 * flag_model):
            return 
        center_distance = center_distance - int(flag_model * 1)
        txt_path = "C:/Users/ZHT2SBY/Desktop/camera_recorrect-main/yolo/result.txt"
